...
<head>
    <meta charset="UTF-8">
    <title> View of Uploded Movies' records</title>
    <link rel="stylesheet" href="dv developer.css" type="text/css">
</head>
<body>
...
<div class="faptt"><img class="fap" src="dvdv.jpg">

    <div class="centro">
        <img class="pnng" src="aa.png"><h1 class="clubi">Admin View of Developers' Records</h1><br><br>

        <table class="aba" border="2" border-color="white"  cellpadding="8xp" cellspacing="9xp"  style="border-collapse: collapse" >
            <tr>
                <th>User Interest</th>
                <th>User Request</th>
                <th>Title</th>
            ...
            $query = "select uinterest,urequest,title,serial,director,rdate,rat,bud,mov,genre,lang,running,gross from developer";
            ...
            while($record = mysqli_fetch_assoc($result)){?>
                ...
                <tr>
                    ...
                    <td > <mark><a class="dele" href="dd.html"
                                   onclick="return confirm('Are You Sure')">Delete
                            </a >  <a class="dele" href="du.html"
