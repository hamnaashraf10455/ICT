...
<head>
    ...
    <link rel="stylesheet" href="dv user.css" type="text/css">
</head>
<body>
...
<div class="faptt"><img class="fap" src="dvvv.jpg">

    <div class="centro">
        <img class="pnng" src="aa.png"><h1 class="clubi">View of Uploaded Data </h1><br><br>
        ...
        <table class="aba" border="2" border-color="white"  cellpadding="12xp" cellspacing="15xp"  style="border-collapse: collapse" >
            ...
            $query = "select title,director,rdate,rat,bud,mov,genre,lang,running,gross from developer";
